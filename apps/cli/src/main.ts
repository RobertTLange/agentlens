...
rag
  ...
  .option("--embedding-limit <n>", "Maximum trace documents to embed")
...
rag
  ...
  .option("--embedding-limit <n>", "Maximum trace documents to embed per pass")
  .option("--lexical-only", "Skip embedding refresh")
...
rag
  ...
  .option("--limit <n>", "Maximum traces per pass")
  .option("--embedding-limit <n>", "Internal trace embedding document limit per pass")
